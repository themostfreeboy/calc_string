...
void test_1()
{
	...
	test_str.push_back("median(1,10,5,9,8)");
	test_str.push_back("median(1,10,5,9,7,6)");
	Calc test_calc;
	test_calc.init_rule();
	for (vector<string>::const_iterator it = test_str.begin(); it != test_str.end(); ++it)
	{
...
void test_2()
{
	...
	while (cin >> str)
	{
		...
		cout << str << " = " << test_calc.calc_process() << endl;
	}
}
